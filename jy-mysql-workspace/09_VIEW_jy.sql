...
INSERT INTO tbl_menu VALUES(null, '식혜맛국밥', 5500, 5, 'Y');
...
WHERE catrgory_name = '한식'; -- tbl_category 베이스테이블에 반영
...
-- 결론 : VIEW는 특정데이터 조회를 위해 만드는 객체 => DML은 지
